const Formulario = () => {
    return (
        <div className="md:w-1/2 lg:w-2/5">
            ...
            <form className="mt-10 bg-white shadow-md rounded-lg py-5 px-5">
                <div>
                    <label className="font-bold" htmlFor="nombre">Nombre mascota:</label>
                    <input className="block mt-2 border-2 w-full p-2 placeholder-gray-400 rounded-lg" type="text" placeholder="Nombre de la mascota" id="nombre"/>
                </div>
                <div className="mt-5">
